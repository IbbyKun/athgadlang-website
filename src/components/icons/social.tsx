...
/**
 * Brand marks for the social links. lucide-react dropped brand icons, so
 * these are the official glyphs as inline paths. They take className the same
 * way lucide icons do.
 */
