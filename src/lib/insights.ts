...
export type Insight = {
  ...
  /** Article body. The first paragraph is rendered as the lead. */
  body: InsightBlock[];
};
 ...
 */
export function adjacentInsights(insight: Insight) {
...
export function relatedInsights(insight: Insight, limit = 4) {
