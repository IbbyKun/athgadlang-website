...
/** Where the site is operated from, per the head office address. */
const operatingLocation = "Dubai, United Arab Emirates";
...
const contactSentence =
  `You can reach us at ${contactDetails.email} or ${contactDetails.phone}.`;
...
export const privacyPolicy: LegalDocument = {
  ...
  closing: `If you have any questions about this Privacy Policy, please contact us. ${contactSentence}`,
};
...
export const termsOfUse: LegalDocument = {
  ...
  closing: `If you have any questions about these Terms of Use, please contact us. ${contactSentence}`,
};
...
export const legalInformation: LegalDocument = {
  ...
  clauses: [
    ...
    },
    {
      ...
      body: [`This website is operated from ${operatingLocation}.`],
    },
    ...governingLawClause(
    ...
    },
    {
      ...
      body: [
        `If you have any questions about these legal terms or this website, please contact us. ${contactSentence} Our head office is at ${contactDetails.address}.`,
      ],
    },
  ],
};

export const legalDocuments = [privacyPolicy, termsOfUse, legalInformation];
